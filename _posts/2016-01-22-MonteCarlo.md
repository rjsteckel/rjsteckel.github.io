...
Recently, I became interested in markov chain monte carlo (MCMC) methods. I have a Statistics degree and 
...
I think Wolfram Alpha is pretty cool. It's an easy interface for some quick calculations. If weren't sure
